        ...
        <div className=''>
            ...
            <div className='m-4 grid md:grid-cols-2 grid-cols-1 gap-6 justify-between'>
                ...
                <div className='border p-4 md:space-y-2 text-gray-700'>
                    ...
                    <button className='px-2 py-1 gradientBg text-white font-semibold'>2021 - 2024</button>
                ...
                <div className='border p-4 md:space-y-2 text-gray-700'>
                    ...
                    <button className='px-2 py-1 gradientBg text-white font-semibold'>2022 - 2023</button>
